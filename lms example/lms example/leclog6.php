...
// fetch files
$sql = "select filename from module";
...
<head>
	<title></title>
	<link rel="stylesheet" type="text/css" href="leclog6.css">
</head>
<body>
		<div class="box1" style="height: 150vh;"><br>
			<h1 style="color: white">&nbspTOPIC OUTLINE-CS107.6</h1>
				<div class="box2" style="border-color: black;border-style: solid;border-width: 15px;margin-left: 175px;">
					<img src="pdf.gif" class="pdf"><a href="http://lms.nsbm.lk/file.php/393/CS104.3_Computer_Architecture_Module_Descriptor.pdf" style="text-decoration: none;"><div class="h"><h4>&nbsp&nbsp&nbspModule Discriptor</h4></div></a>
					...
					<img src="pdf.gif" class="pdf"><a href="http://lms.nsbm.lk/file.php/393/Assignment.pdf" style="text-decoration: none;"><div class="h"><h4>&nbsp&nbsp&nbspAssignment</h4></div></a>
				</div>
				<br><br>
